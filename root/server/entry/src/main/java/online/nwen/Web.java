...
import online.nwen.entry.interceptor.InitializeSecurityContextInterceptor;
...
public class Web implements WebMvcConfigurer {
    ...
    private InitializeSecurityContextInterceptor initializeSecurityContextInterceptor;
    private ParseJwtInterceptor parseJwtInterceptor;

    public Web(
            InitializeSecurityContextInterceptor initializeSecurityContextInterceptor,
            ParseJwtInterceptor parseJwtInterceptor) {
        this.initializeSecurityContextInterceptor = initializeSecurityContextInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(this.initializeSecurityContextInterceptor)
